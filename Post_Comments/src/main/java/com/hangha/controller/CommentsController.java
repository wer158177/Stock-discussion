...
public class CommentsController {
    ...
    public ResponseEntity<Void> likeComment(HttpServletRequest request,@PathVariable Long commentId) {
        Long userId = jwtUtil.extractUserIdFromToken(request);
    ...
    public ResponseEntity<Void> unlikeComment(HttpServletRequest request,@PathVariable Long commentId) {
        Long userId = jwtUtil.extractUserIdFromToken(request);
