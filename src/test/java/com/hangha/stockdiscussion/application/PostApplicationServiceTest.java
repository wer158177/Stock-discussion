package com.hangha.stockdiscussion.application;
...
class PostApplicationServiceTest {
    ...
    void postWrite_ShouldCallWritePost() {
        ...
        verify(postInterface, times(1)).writePost(command);
    }
    ...
    void postUpdate_ShouldCallUpdatePost() {
        ...
        verify(postInterface, times(1)).updatePost(command);
    }
    ...
    void postDelete_ShouldCallDeletePost() {
        ...
        verify(postInterface, times(1)).deletePost(postId, userId);
    }
